class PartOptionCompatibility < ActiveRecord::Base
  ...
  def self.with_variants_and_parts_ids
    select("part_option_compatibilities.*, pv1.part_variant_id as part_variant_1_id, pv2.part_variant_id as part_variant_2_id, v1.part_id as part_1_id, v2.part_id as part_2_id")
